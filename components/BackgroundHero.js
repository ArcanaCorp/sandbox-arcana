...
export default function DottedBackground({
  ...
  const glyphTextureRef =
    useRef(null);

  const glyphGridRef =
    useRef(null);

  const dummyGlyphTextureRef =
    useRef(null);
  ...
  useEffect(() => {
    ...
    if (
      ...
      dotProgram.uniforms.uGlyphAtlas.value =
        atlas.texture;

      dotProgram.uniforms.uGlyphGrid.value =
        [
          atlas.cols,
          atlas.rows,
        ];

      dotProgram.uniforms.uCharCount.value =
        atlas.count;

      dotProgram.uniforms.uUseGlyphAtlas.value =
        1;
    }
    ...
    const update = (
      ...
      perlinProgram.uniforms.uTime.value =
        time * 0.001;
  ...
  useEffect(() => {
    ...
    if (dot) {
      dot.uniforms.uPaletteCount.value =
        effPaletteCount;

      dot.uniforms.uPalette.value =
        palette.rgb;

      dot.uniforms.uPaletteA.value =
        palette.alpha;
      ...
      if (
        ...
        try {
          ...
          dot.uniforms.uGlyphGrid.value =
            [
              atlas.cols,
              atlas.rows,
            ];

          dot.uniforms.uCharCount.value =
            atlas.count;

          dot.uniforms.uUseGlyphAtlas.value =
            1;
        } catch {
          dot.uniforms.uUseGlyphAtlas.value =
            0;
